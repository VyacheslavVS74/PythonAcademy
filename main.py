...
#
# # print(todos[:10])
# # print(type(todos))  # todos это класс list
#
# todos_by_user = {}
# for i in todos:
#     if i["completed"]:
#         try:
#             todos_by_user[i["userId"]] += 1  # todos_by_user{1: 2}  2
#         except KeyError:
#             todos_by_user[i["userId"]] = 1  # todos_by_user{1: 1}  1
#
# print(todos_by_user)
#
...
# csv.reader(имя файла) []
# csv.Dictreader() {}
# csv.writer() для записи []
# csv.DictWriter() {}
...
# with open("data_dict_sw.csv", mode="w") as f:
#     names = ["Имя", "Возраст"]
...
# pip install bs4 или beatifulsoup4
...
# Задача в папке Articles  и в dz_45

# 14.02.2023 Базы данных в папке BD ===================================================================================
